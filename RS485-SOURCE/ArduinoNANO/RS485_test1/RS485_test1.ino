...
/*
  ...
  115200  173
*/
#define BAUDRATE 9600 // Slower is generally better, but I get good results here.
#define RS485_1_BPS 4800 // Slower is generally better, but I get good results here.
#define RS485_2_BPS 4800 // Slower is generally better, but I get good results here.
...
boolean debug = true;       // enables an ecco test, overides master
...
void setup() {
  ...
  rs485Port1.begin(RS485_1_BPS);
  rs485Port2.begin(RS485_2_BPS);
